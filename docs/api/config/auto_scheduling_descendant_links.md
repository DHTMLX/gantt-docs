...
:::warning
The property has been deprecated in v9.1, use the `descendant_links` property of [gantt.config.auto_scheduling](api/config/auto_scheduling.md#descendant_links) instead.
:::
