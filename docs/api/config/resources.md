...
@short: Defines an extra configuration for the resource store
...
- **lightbox_resources? (resourceArray): any** - optional, a function which takes all resources as an argument and must return an array of resources that should be available in the resource control of the lightbox. By default, the control will be populated with resources that don't have sub-resources. 
