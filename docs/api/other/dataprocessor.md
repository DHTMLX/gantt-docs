...
description: "a set of dataprocessor methods"
---
...
A new instance of DataProcessor can be created using [createDataProcessor](api/method/createdataprocessor.md) method. Alternatively, the [dataProcessor](api/method/dataprocessor.md) constructor provides a legacy way to create a DataProcessor instance. 
...
<ul id="attachEvent">
	<li>
		...
		<ul><li><b><i>name</i></b> - (<i>string</i>) - the event's name, case-insensitive</li><li><b><i>handler</i></b> - (<i>Function</i>) - the handler function</li><li><b><i>settings?</i></b> - (<i>object</i>) - optional, an object with settings for the event handler</li></ul>
	</li>
</ul>
<ul>
	~~~js
