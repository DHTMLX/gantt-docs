...
description: "calculates the position and size of the task's DOM element in the timeline area"
---
...
- `from` - (optional) *Date* -  the start date of the item
- `to`- (optional) *Date* - the end date of the item
...
- **height** - the CSS height of the bar element in pixels (defined either by the [bar_height](api/config/bar_height.md) configuration or the *task.bar_height* property of the task object)
- **rowHeight** - the CSS height of the task row in pixels (defined either by the [row_height](api/config/row_height.md) configuration or the *task.row_height* property of the task object) (added in v7.1)
