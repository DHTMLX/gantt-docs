...
:::note
To try out the functionality, download the [demo](https://files.dhtmlx.com/30d/914357ff4315af5d6bfd79e2f4e3f8fb/gantt_node_export_demo.zip). To run the demo you need to install the [gantt-node](guides/using-gantt-on-server.md#terms-of-using) package.
:::

To configure export/import for your project, enable the <b>export_api</b> plugin via the [plugins](api/method/plugins.md) method:
