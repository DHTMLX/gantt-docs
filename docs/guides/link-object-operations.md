---
title: "Getting the Link Object/Id"
sidebar_label: "Getting the Link Object/Id"
---
...
To get a link object, use the [getLink](api/method/getlink.md) method:
...
To get all links presented in the chart, use the [getLinks](api/method/getlinks.md) method as in:
...
The **task.$source** and **task.$target** are [dynamic properties of the task object](guides/loading.md#dataproperties) and contain ids of links connected to the task.
...
To change the current id of a link, use the [changeLinkId](api/method/changelinkid.md) method:
~~~js
