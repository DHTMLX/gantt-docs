---
title: "Adding/Updating/Deleting Links"
...
Note, to update all links in the Gantt chart at once, use the [refreshData](api/method/refreshdata.md) method:
...
- capture the [onLinkDblClick](api/event/onlinkdblclick.md) event; 
- cancel the default handler; 
- display a popup from the event handler.

On the last step you can either use [built-in popups ](guides/message-boxes.md) or implement some custom solution.
