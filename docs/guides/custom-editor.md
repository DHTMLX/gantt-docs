...
Unlike the default Gantt [resource control](guides/resources.md), it allows just assigning resources to a task without setting their quantity. However, it can be useful, if you want a pretty simple control.
