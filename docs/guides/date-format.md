...
- **%w** - the week number, weeks start either on Monday or on Sunday depending on the value of the [start_on_monday](api/config/start_on_monday.md) config property 
