...
**Related sample**: [Grid columns rightside of gantt](https://docs.dhtmlx.com/gantt/samples/10_layout/01_rightside_columns.html)
...
**Related sample**: [Gantt chart with resource panel](https://docs.dhtmlx.com/gantt/samples/10_layout/02_resource_panel.html)
...
- **resourceGrid** - preconfigured grid for a resource panel. **Available in the PRO edition only**. See more details [here](guides/resource-management.md).
- **resourceTimeline** - preconfigured timeline for a resource panel. **Available in the PRO edition only**. See more details [here](guides/resource-management.md).

The view configuration is specified as an object with the corresponding properties. 
You can [set custom configuration options](#configs-and-templates-of-views) for the **grid** and **timeline** views. 
The default options are taken from the global [gantt.config](guides/common-configuration.md#ganttconfigobject) object.
...
It is also possible to specify a separate horizontal scrollbar for the Grid view. [Read the details](guides/specifying-columns.md#horizontal-scrollbar) in the corresponding section.
...
To populate custom views with corresponding data, you need to add a separate data store. To create a new data store, use the method [createDatastore](api/method/createdatastore.md) and specify the configuration of the data store:
...
To load data into custom views from the data store, use the [parse](api/method/parse.md) method:
...
To return a configuration object of the necessary data store, use the [getDatastore](api/method/getdatastore.md) method:
...
:::note
If you use built-in resource views, the gantt can automatically create the data store for them. [Read the details](guides/resource-management.md#working-with-resource-view-panel).
:::

### Disabling/enabling resizers dynamically {#enable_disable_resizers}
...
Check the [Resource Management](guides/resource-management.md) article.
...
**Related sample**: [Hiding grid/timeline views](https://snippet.dhtmlx.com/5/157c0db66)
