...
A set of selectors for setting the [baselines](guides/inbuilt-baselines.md) for a task by specifying the start date of a task and the number of days.
