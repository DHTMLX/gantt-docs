---
title: "Dragging Tasks within the Timeline"
...
Tasks of the [project type](api/config/types.md) are not draggable by default.
You can enable drag and drop of projects using the [drag_project](api/config/drag_project.md) config:
...
Besides, you can adjust the speed of autoscrolling in milliseconds with the help of the corresponding property - [autoscroll_speed](api/config/autoscroll_speed.md):
