---
title: "Links Coloring and Styling"
...
## Structure of the link DOM element {#structureofthelinkdomelement}
...
You can apply classes from the [link_class](api/template/link_class.md) template to this element. 
...
The width of this element is defined by the [link_wrapper_width](api/config/link_wrapper_width.md) configuration property.
...
The size of the **gantt_link_arrow** element is defined by the [link_arrow_size](api/config/link_arrow_size.md) configuration property.
...
The width of this element can be changed via the [link_line_width](api/config/link_line_width.md) configuration property:

~~~js
gantt.config.link_line_width = 3;
~~~

- **gantt_link_corner** -  the rounded corner of a link line. The corner radius is defined by [link_radius](api/config/link_radius.md):
...
## Redefining the link's template {#redefiningthelinkstemplate}

To style dependency links, use the [link_class](api/template/link_class.md) template. For example, to color links depending on the tasks priority, use the code as in:
...
:::note
To style other elements of dependency links, use the templates listed in the [Templates of Dependency Links](guides/dependency-templates.md) article.
:::

A similar approach can be applied to tasks. Read more about it [here](guides/colouring-tasks.md#redefiningthetaskstemplate).


## Specifying color in the property of the link object {#specifyingcolorinthepropertiesofthelinkobject}
...
A similar approach can be applied to tasks. Read more about it [here](guides/colouring-tasks.md#specifyingstyleinthepropertiesofataskobject).
