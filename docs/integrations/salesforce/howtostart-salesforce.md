---
title: "dhtmlxGantt with Salesforce LWC"
...
You can also install [Salesforce Extension Pack](https://marketplace.visualstudio.com/)" to Visual Studio Code for working with development orgs. 
