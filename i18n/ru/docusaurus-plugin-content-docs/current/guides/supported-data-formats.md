---
title: "Поддерживаемые форматы данных"
sidebar_label: "Поддерживаемые форматы данных"
---

# Поддерживаемые форматы данных

dhtmlxGantt поддерживает загрузку данных в нескольких форматах:
...
### Задачи с ресурсами и назначениями ресурсов
...
- **priority** - указывает уровень приоритета задачи.
- **holder**  - определяет пользователя, назначенного на задачу.
...
## JSON с коллекциями {#jsonwithcollections}

JSON-данные могут содержать несколько дополнительных массивов внутри свойства "collections" объекта *data*.
...
Доступ к этим коллекциям можно получить по их именам с помощью метода [gantt.serverList](api/method/serverlist.md).
