...
## Расширенное drag-n-drop {#advanced-drag-n-drop}
...
## Перетаскивание временной шкалы {#drag-timeline}
...
## Сервис экспорта {#export-service}
...
## Вертикальный маркер {#vertical-marker}
