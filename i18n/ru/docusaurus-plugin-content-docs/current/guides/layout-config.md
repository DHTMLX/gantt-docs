...
## Стандартная раскладка {#default-layout}
...
## Настройка раскладки {#layout-customization}
...
## HTML как внутренний вид {#html-as-inner-view}
...
## Обязательные виды и настройки {#required-views-and-settings}
...
## Конфигурации и шаблоны видов {#configs-and-templates-of-views}
...
## Группы видимости {#visibility-groups}
