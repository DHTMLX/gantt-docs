...
См. пример в разделе [Как отобразить несколько строк в ячейке/заголовке грида](guides/how-to.md#how-to-display-several-lines-in-the-grid-cellheader).
...
См. примеры в разделе [Как отобразить несколько строк в ячейке/заголовке грида](guides/how-to.md#how-to-display-several-lines-in-the-grid-cellheader).
...
Подробнее см. в [Настройка шкалы](guides/configuring-time-scale.md#styling) и [Выделение временных слотов](guides/highlighting-time-slots.md).
...
См. [пример](https://snippet.dhtmlx.com/55uy7ibo) в разделе [Как отобразить несколько строк в ячейке/заголовке грида](guides/how-to.md#how-to-display-several-lines-in-the-grid-cellheader).
...
[отдельной статье](guides/crud-dependency.md#editing-link-values-from-ui).
