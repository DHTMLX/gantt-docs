...
## Запрет перетаскивания отдельных задач {#denying-dragging-of-specific-tasks}
...
## Запрет перетаскивания задач за пределами конкретных дат {#denying-dragging-tasks-out-of-specific-dates}
...
## Перетаскивание дочерних задач вместе с родителем {#dragging-children-together-with-the-parent}
...
## Установка минимальной продолжительности задачи {#setting-minimal-task-duration}
...
## Отключение изменения размера конкретных задач {#disabling-resize-of-specific-tasks}
...
## Какая сторона задачи изменяется при изменении размера {#which-side-of-a-task-is-being-resized}
...
## Отключение изменения размера начала или конца даты задачи {#disabling-resize-of-the-start-or-the-end-date-of-a-task}
