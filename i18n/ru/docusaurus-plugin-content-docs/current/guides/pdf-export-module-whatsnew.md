...
- Перенес движок рендеринга PDF/PNG на Puppeteer
- Заголовок и нижний колонтитул, отображаемые на каждой странице многостраничного экспорта PDF, теперь располагаются поверх содержимого страницы
- Установлено корректное масштабирование DPI для Scheduler при экспорте в PDF и PNG
...
- Исправления для фиксированных ячеек шкалы при экспорте `raw`
