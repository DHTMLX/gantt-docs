...
:::info
Начиная с версии v10, эта функциональность доступна во всех редакциях (бесплатное Community-издание и PRO-издания). В более ранних версиях она была ограничена Commercial (с 6 октября 2021 года), Enterprise и Ultimate лицензиями.
:::
...
## Конфигурация экземпляра Gantt {#gantt-instance-configuration}
...
:::note
Если вы используете пакет, который не позволяет создавать несколько экземпляров объекта gantt (устаревшее GPL-издание в v9.x и ранее, или однодоменная Commercial сборка), вызов деструктора gantt сделает gantt недоступным до перезагрузки страницы.
:::