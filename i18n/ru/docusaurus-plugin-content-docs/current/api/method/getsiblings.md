...
title: метод getSiblings
description: "возвращает соседей указанной задачи (включая саму задачу)"
---
...
@short: Возвращает соседей указанной задачи (включая саму задачу)
...
### Returns
- `siblings` - (array) - идентификаторы соседей задачи
...
Соседи — задачи на одном уровне дерева
