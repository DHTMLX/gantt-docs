...
- `code` - (required) *string* - WBS-код задачи
...
### Related samples
- [Показать WBS-коды задач (Outline Numbers)](https://docs.dhtmlx.com/gantt/samples/07_grid/09_wbs_column.html)
