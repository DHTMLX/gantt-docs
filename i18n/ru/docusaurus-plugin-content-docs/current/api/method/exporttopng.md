...
<table class="webixdoc_links">
  ...
  <tr>
			...
			<td>(<i>string</i>) задаёт API-эндпойнт для запроса. Может использоваться с локальной установкой сервиса экспорта. Значение по умолчанию `https://export.dhtmlx.com/gantt`</td>
		</tr>
  <tr>
