...
Метод [](api/method/exporttopdf.md) принимает в качестве параметра объект с набором свойств (все свойства являются необязательными):
 ...
 <table class="webixdoc_links">
  ...
  <tr>
			...
			<td>(<i>string</i>) устанавливает конечную точку API-запроса. Может использоваться с локальной установкой сервиса экспорта. Значение по умолчанию: `https://export.dhtmlx.com/gantt`</td>
		</tr>
  <tr>
