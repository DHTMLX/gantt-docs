...
**show_chart** 选项仅在布局保持其[默认配置](guides/layout-config.md#default-layout)且未通过 [gantt.config.layout](api/config/layout.md) 修改时生效。如果你使用自定义布局，则需要定义多个自定义配置并在它们之间切换，以控制图表的可见性。
