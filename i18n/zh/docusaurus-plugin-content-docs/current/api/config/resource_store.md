...
title: resource_store 配置
description: "指定与 resourceGrid/resourceTimeline/resourceHistogram 视图相连的数据存储的名称"
---
...
@short: 指定与 resourceGrid/resourceTimeline/resourceHistogram 视图相连的数据存储的名称
...
定义一个数据存储，该存储连接到 "resourceGrid" 和 "resourceTimeline" 视图。或者，可以设置视图的 "bind" 属性。
