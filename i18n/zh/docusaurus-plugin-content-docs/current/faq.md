...
因此，请务必在安装 PRO 版本前彻底移除甘特图试用包的文件。更多信息请参阅 [Adding PRO Edition into Project](guides/installation.md#adding-pro-edition-into-project) 部分。
