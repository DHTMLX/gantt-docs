...
@short: 라이트박스 구조의 이름을 저장합니다(다양한 작업 유형에 사용)
...
The 'types' object consists of the **"type programmatic name"**: **"type identifier"** 쌍으로 구성됩니다:
...
Gantt는 태스크 유형에 따라 라이트박스를 사용합니다:
