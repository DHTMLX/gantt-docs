...
:::note
현재, DHTMLX Gantt에 대해 네이티브 Vue 컴포넌트가 존재하지 않습니다.
그러나 아래 자료를 사용하면 Vue 애플리케이션에 DHTMLX Gantt를 쉽게 통합할 수 있습니다.
:::
...
이 가이드를 따르면 Vue 프로젝트 내에서 DHTMLX Gantt를 효과적으로 사용할 수 있으며, 그 모든 기능을 활용할 수 있습니다.