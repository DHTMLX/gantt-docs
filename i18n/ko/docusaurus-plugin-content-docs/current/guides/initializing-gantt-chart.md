...
## 프로젝트에 Gantt 소스 파일 추가하기 {#how-to-add-gantt-source-files-into-a-project}
...
## \<script\> 태그를 통한 파일 포함하기 {#include-files-via-the-script-tag}
...
## Vite로 Gantt 사용하기 {#using-gantt-with-vite}
...
## Svelte 프로덕션 빌드 {#svelte-production-build}
