---
title: "지원 가능한 데이터 형식" 
sidebar_label: "지원 가능한 데이터 형식" 
---

# 지원 가능한 데이터 형식

dhtmlxGantt는 다음 형식으로 데이터를 로드할 수 있습니다:
...
또한 [add any custom properties to the Gantt data](guides/supported-data-formats.md#custom-properties-in-data)를 Gantt 데이터에 추가할 수 있습니다.
...
자원 할당은 작업과 별도로 메서드에 전달될 수 있습니다:
...
## 데이터의 커스텀 속성 {#custom-properties-in-data}

위의 예제를 2개의 커스텀 속성으로 살펴보겠습니다:

- **priority** - 작업의 우선순위.
- **holder**  - 작업에 배정된 사람의 이름.
...
JSON 데이터는 *data* 객체의 "collections" 속성에 임의의 추가 배열을 포함할 수 있습니다.
...
적용된 컬렉션은 [gantt.serverList](api/method/serverlist.md) 메서드를 사용하여 이름으로 접근할 수 있습니다.
