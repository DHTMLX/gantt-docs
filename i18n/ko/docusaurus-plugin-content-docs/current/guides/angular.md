...
:::note
현재, DHTMLX Gantt용 네이티브 Angular 컴포넌트가 아직 없습니다.
하지만 아래 자료를 활용하면 Angular 애플리케이션에 DHTMLX Gantt를 여전히 쉽게 통합할 수 있습니다.
:::
...
이 가이드를 따르면 Angular 프로젝트 내에서 DHTMLX Gantt를 효과적으로 사용할 수 있으며 그 모든 기능을 최대한 활용할 수 있습니다.