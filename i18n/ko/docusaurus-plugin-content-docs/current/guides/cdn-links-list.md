...
이 문서에서는 CDN을 통해 Gantt 기능을 추가할 수 있는 모든 링크를 제공합니다.  
각 항목은 특정 Gantt 버전에 해당합니다:

- 코어 파일 - 주요 기능이 포함된 *dhtmlxgantt.js* 및 *dhtmlxgantt.css* 파일
- 스킨 - 모든 사용 가능한 [스킨](guides/skins.md) 링크


최신 Gantt 버전  
-----------------------

최신 버전의 라이브러리를 사용하려면 소스 경로를 **https://cdn.dhtmlx.com/gantt/edge/...** 로 설정하세요.

코어 파일: [JS](  https://cdn.dhtmlx.com/gantt/edge/dhtmlxgantt.js ), [CSS](  https://cdn.dhtmlx.com/gantt/edge/dhtmlxgantt.css )

스킨: [Terrace](https://cdn.dhtmlx.com/gantt/edge/skins/dhtmlxgantt_terrace.css),  
...
최신 Gantt 버전, 압축 해제 버전  
-----------------------------

최신 라이브러리의 압축 해제 버전을 사용하려면 경로를 **https://cdn.dhtmlx.com/gantt/edge/sources/...** 로 설정하세요.

코어 파일: [JS](  https://cdn.dhtmlx.com/gantt/edge/sources/dhtmlxgantt.js ),  
[CSS](  https://cdn.dhtmlx.com/gantt/edge/sources/skins/dhtmlxgantt_terrace.css )


스킨: [Terrace](  https://cdn.dhtmlx.com/gantt/edge/sources/skins/dhtmlxgantt_terrace.css ),  
...
특정 버전의 라이브러리를 사용하려면 소스 경로를 **https://cdn.dhtmlx.com/gantt/[version_number]/...** 로 설정하세요.

코어 파일: [JS](  https://cdn.dhtmlx.com/gantt/4.0/dhtmlxgantt.js ),  
[CSS](  https://cdn.dhtmlx.com/gantt/4.0/dhtmlxgantt.css )


스킨: [Terrace](  https://cdn.dhtmlx.com/gantt/4.0/skins/dhtmlxgantt_terrace.css ),  
...
특정 Gantt 버전, 압축 해제 버전  
-------------------------------

특정 버전의 압축 해제 파일을 사용하려면 경로를 **https://cdn.dhtmlx.com/gantt/[version_number]/sources/...** 로 설정하세요.

코어 파일: [JS](  https://cdn.dhtmlx.com/gantt/4.0/sources/dhtmlxgantt.js ),  
[CSS](  https://cdn.dhtmlx.com/gantt/4.0/sources/skins/dhtmlxgantt_terrace.css  )


스킨: [Terrace](  https://cdn.dhtmlx.com/gantt/4.0/sources/skins/dhtmlxgantt_terrace.css ),  
