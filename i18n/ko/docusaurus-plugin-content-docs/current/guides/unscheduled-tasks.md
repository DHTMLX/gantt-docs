---
title: "날짜가 지정되지 않은 작업"
sidebar_label: "날짜가 지정되지 않은 작업"
---
...
다음과 같이 작업의 설명에서 **unscheduled** 속성을 값 *true*로 설정하면 구현할 수 있습니다:
...
unscheduled 작업을 표시하려면 구성 매개변수 [show_unscheduled](api/config/show_unscheduled.md)을 *false*로 설정합니다:
...
[미정렬 작업 보기](https://docs.dhtmlx.com/gantt/samples/01_initialization/19_tasks_without_dates.html)