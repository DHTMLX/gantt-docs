...
## 프레임워크별 빠른 시작 {#quick-start-by-framework}
...
- 독립적인 JS 위젯으로 삽입
- [React](integrations/react), [Angular](integrations/angular/), [Vue](integrations/vue/), [Svelte](integrations/svelte/howtostart-svelte) 래퍼로 사용
