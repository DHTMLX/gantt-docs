...
Die aktuellen locale-Einstellungen werden im **gantt.locale** Objekt gespeichert und können direkt aktualisiert werden, zum Beispiel:
...
Beide Methoden werden unterstützt und funktionieren einwandfrei. Die Verwendung der [gantt.i18n](api/other/i18n.md) Objekt-API wird jedoch empfohlen.
