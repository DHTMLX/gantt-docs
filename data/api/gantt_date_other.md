...
~~~
    ...
    <li>
    	<b>add_quarter (date, number)</b> - adds/subtracts the specified number of quarters to/from the date
        <ul>
...
~~~
     ...
     <li>
    	<b>minute_start (date) </b> - returns a Date object of the specified date and clears the part with seconds to zero
        <ul>
          	<li><b><i>date</i></b> - (<i>Date</i>) the date object to format </li>
~~~js
...
~~~
    ...
    <li>
    	<b>hour_start (date) </b> - returns a Date object of the specified date and clears the part with minutes and seconds to zero
        <ul>
          	<li><b><i>date</i></b> - (<i>Date</i>) the date object to format </li>
~~~js
...
~~~
    ...
    <li>
    	<b>quarter_start (date) </b> - returns a Date object of the first month of the quarter for the specified date and clears the time part to zero
        <ul>
          	<li><b><i>date</i></b> - (<i>Date</i>) the date object to format </li>
~~~js
