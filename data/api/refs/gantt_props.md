...
- api/gantt_inline_editors_multiselect_open_config.md - defines whether inline editors should be opened after one click on a task when multi-task selection is enabled
...
- api/gantt_container_resize_method_config.md
...
- api/gantt_inline_editors_multiselect_open_config.md
