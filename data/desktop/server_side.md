...
One more way to add custom parameters to a request is to use the [onBeforeUpdate](api/gantt_dataprocessor_other.md#onBeforeUpdate) event of DataProcessor:
