...
<script type="text/javascript">
    var features = [
        ...
        {"name":"Creating multiple Gantt charts on one page (<strong>Enterprise and Ultimate licenses only</strong>)\n", "url":"desktop__multiple_gantts.html", "standard":false,"pro":true},
        ...
        {"name":"Splitting tasks into subtasks", "url":"desktop__split_tasks.html", "standard":false,"pro":true},
        ...
        {"name":"Link formatter for the  Predecessor editor", "url":"desktop__inline_editing.html#linkformatter", "standard":false,"pro":true},
	]
