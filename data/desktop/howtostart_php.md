...
{{note This tutorial uses an older Slim Framework v3.x. If you're looking for the most recent version of the tutorial, check the [Slim Framework v4.x](desktop/howtostart_php_slim4.md) guide.}}
