...
- Fix the issue which caused [dataProcessor](desktop/server_side.md) not to send all updates from different datastores when the [auto-update mode](https://docs.dhtmlx.com/api__dataprocessor_setupdatemode.html) is disabled
